...
function $CompileProvider($provide) {
  ...
  this.$get = [
    ...
    function wrongMode(localName, mode) {
      throw new NgError(11, "Unsupported '{0}' for '{1}'.", mode, localName);
    }
    ...
    function applyDirectivesToNode(directives, compileNode, templateAttrs, transcludeFn, $rootElement) {
        ...
        if (directiveValue = directive.template) {
          ...
          if (directive.replace) {
            if ($template.length != 1 || compileNode.nodeType !== 1) {
              throw new NgError(12, '{0}{1}', MULTI_ROOT_TEMPLATE_ERROR, directiveValue);
            }
      ...
      function getControllers(require, $element) {
        ...
        if (isString(require)) {
          ...
          if (!value && !optional) {
            throw new NgError(13, "No controller: {0}", require);
          }
          return value;
            ...
            switch (mode) {
              ...
              case '=': {
                ...
                parentSet = parentGet.assign || function() {
                  ...
                  throw new NgError(14, '{0}{1} (directive: {2})', NON_ASSIGNABLE_MODEL_EXPRESSION,
              ...
              default: {
                throw new NgError(15, 'Invalid isolate scope definition for directive {0}: {1}',
      ...
      $http.get(origAsyncDirective.templateUrl, {cache: $templateCache}).
        success(function(content) {
          ...
          if (replace) {
            ...
            if ($template.length != 1 || compileNode.nodeType !== 1) {
              throw new NgError(16, '{0}{1}', MULTI_ROOT_TEMPLATE_ERROR, content);
            }
        ...
        error(function(response, code, headers, config) {
          throw new NgError(17, 'Failed to load template: {0}', config.url);
        });
    ...
    function assertNoDuplicate(what, previousDirective, directive, element) {
      if (previousDirective) {
        throw new NgError(18, 'Multiple directives [{0}, {1}] asking for {2} on: {3}',
