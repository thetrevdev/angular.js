...
function $RootScopeProvider(){
  ...
  this.$get = ['$injector', '$exceptionHandler', '$parse',
    ...
    Scope.prototype = {
      ...
      $new: function(isolate) {
        ...
        if (isFunction(isolate)) {
          ...
          throw new NgError(26, 'API-CHANGE: Use $controller to instantiate controllers.');
        }
        if (isolate) {
          child = new Scope();
    ...
    function beginPhase(phase) {
      if ($rootScope.$$phase) {
        throw new NgError(28, '{0} already in progress', $rootScope.$$phase);
      }
