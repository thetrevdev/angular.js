...
var ngBindDirective = valueFn(function(scope, element, attr) {
  element.addClass('ng-binding').data('$ngBinding', attr.ngBind);
...
var ngBindHtmlUnsafeDirective = valueFn(function(scope, element, attr) {
  element.addClass('ng-binding').data('$ngBinding', attr.ngBindHtmlUnsafe);
...
var ngBindHtmlDirective = ['$sanitize', function($sanitize) {
  return function(scope, element, attr) {
    element.addClass('ng-binding').data('$ngBinding', attr.ngBindHtml);
...
var ngBindTemplateDirective = ['$interpolate', function($interpolate) {
  return function(scope, element, attr) {
    ...
    element.addClass('ng-binding').data('$ngBinding', interpolateFn);
