...
describe('jqLite', function() {
  ...
  describe('data', function() {
    ...
    it('should replace existing data object with a new one if called with a single object arg',
        function() {
      var element = jqLite(a);
      element.data('foo', 'bar');
      expect(element.data()).toEqual({foo: 'bar'});

      expect(element.data({meLike: 'turtles', 'youLike': 'carrots'})).toBe(element);
      expect(element.data()).toEqual({meLike: 'turtles', youLike: 'carrots'});
    });
  });
