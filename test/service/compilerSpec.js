...
describe('$compile', function() {
  ...
  describe('directives', function() {
    ...
    it('should prevent changing of structure', inject(function($compile, $rootScope){
    ...
    it('should allow restriction of attributes', inject(
      ...
      function($rootScope, $compile, log) {
        ...
        expect(log).toEqual({ clazz: 1 });
        copy({}, log);

        dealoc($compile('<all class="all" all></all>')($rootScope));
        expect(log).toEqual({ all: 3 });
        copy({}, log);
      }
    ));
